...
public class ParkingServiceImpl implements ParkingService{
	...
	public int printMenu() {
		...
		System.out.println("1) 주차	2) 출차	3) 주차이력  4) 종료 ");
		int menu = sc.nextInt();
	...
	public void outParking() {
		...
		HashMap<String, Object> parkingMap = new HashMap<String, Object>();
		parkingMap = parkingDAO.selectParkingInfo(location);
		parkingDAO.insertParkingHistory(location, parkingMap.get("parkingCarNumber").toString(), "0");
	...
	public void insertParkingHistory() {

		System.out.println("주차 이력");
